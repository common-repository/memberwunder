...
namespace MemberWunder\Libraries;
...
class lessc {
    ...
    protected function lib_luma($color) {
        ...
        if( isset( $color[0] ) && $color[0] == 'color' ):
            unset( $color[0] );
    ...
    protected function newFormatter() {
        $className = "\MemberWunder\Libraries\lessc_formatter_lessjs";
        if (!empty($this->formatterName)) {
            if (!is_string($this->formatterName))
                return $this->formatterName;
            $className = "\MemberWunder\Libraries\lessc_formatter_$this->formatterName";
        }
...
class lessc_parser {
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            self::$operatorString = '(' . implode('|', array_map(array('\MemberWunder\Libraries\lessc', 'preg_quote'), array_keys(self::$precedence))) . ')';
    ...
    protected function isDirective($dirname, $directives) {
        ...
        $pattern = implode("|", array_map(array('\MemberWunder\Libraries\lessc', "preg_quote"), $directives));
    ...
    protected function openString($end, &$out, $nestingOpen = null, $rejectStrs = null) {
        ...
        $stop = array("'", '"', "@{", $end);
        $stop = array_map(array('\MemberWunder\Libraries\lessc', "preg_quote"), $stop);
